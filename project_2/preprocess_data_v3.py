...
if __name__ == "__main__":
    ...
    df_train.to_csv(os.path.join("data_pp", "sct_v3.train.tsv"), sep="\t", header=True, index=False)
    df_val.to_csv(os.path.join("data_pp", "sct_v3.validation.tsv"), sep="\t", header=True, index=False)
    df_test.to_csv(os.path.join("data_pp", "sct_v3.test.tsv"), sep="\t", header=True, index=False)
    ...
    df_train_test.to_csv(os.path.join("data_pp_test", "sct_v3.train.tsv"), sep="\t", header=True, index=False)
    df_val.to_csv(os.path.join("data_pp_test", "sct_v3.validation.tsv"), sep="\t", header=True, index=False)
    df_test.to_csv(os.path.join("data_pp_test", "sct_v3.test.tsv"), sep="\t", header=True, index=False)
    ...
    # df_train = pp_data_train(data_train, sentiment=True, common_sense=True)
    # df_val = pp_data_val(data_val, sentiment=True, common_sense=True)
    # df_test = df_val[["unique_id", "label", "text_a", "text_b_pos", "text_b_neg",
    #                   "vs_sent1", "vs_sent2", "vs_sent3", "vs_sent4",
    #                   "vs_sent5_pos", "cs_dist_pos", "vs_sent5_neg", "cs_dist_neg"
    ...
    #     os.makedirs("data_pp_test")
    #
    # df_val.iloc[0:1500].to_csv(os.path.join("data_pp_test", "sct_v2.train.tsv"), sep="\t", header=True, index=False)
    # df_val.iloc[1500:].to_csv(os.path.join("data_pp_test", "sct_v2.validation.tsv"), sep="\t", header=True, index=False)
